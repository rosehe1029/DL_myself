...
class RNN_model(nn.Module):
    def __init__(self, batch_sz ,vocab_len ,word_embedding,embedding_dim, lstm_hidden_dim):
        ...
        # ???
        self.num_layers=2
        self.lstm_dim=nn.LSTM(self.word_embedding_dim,self.hidden_dim,num_layers=2)
    ...
    def forward(self,sentence,is_test = False):
        ...
        # ???
        h0=torch.zeros(self.num_layers*1,self.batch_size,self.lstm_dim)    ## (num_layers* 1,batch_size,hidden_size)
        c0=torch.zeros(self.num_layers*1,self.batch_size,self.lstm_dim)
